...
export const COMPONENTS: Component[] = [
  ...
  // ── Organisms ──────────────────────────────────────────────────────────────
  {
    ...
    category: "Organism",
    useFor: "Content containers and panels. Add interactive prop for clickable cards that show blue border on hover (e.g. microservice catalog cards).",
    neverUse: "Never build a custom <div> with manual border and padding when Card is available. Never use style={{}} for card layout — use the interactive prop for hover states.",
    props: ["className", "interactive"],
    notes: "interactive=true adds hover:border-primary-border-default + pointer cursor. Uses CDS tokens: radius-l (10px), huegrey-border-fairish border, white background. Import CardHeader, CardTitle, CardDescription, CardContent, CardFooter, CardAction from same path. For microservice/feature cards with H4 title, use interactive Card with custom flex-col layout inside — do NOT use CardHeader/CardContent wrappers for those.",
  },
  {
    name: "Dialog",
    file: "dialog.tsx",
  ...
  },
  {
    ...
    neverUse: "Never use Dialog or window.confirm() for destructive confirmations. Never add style={{background}} to AlertDialogAction — the variant prop handles color automatically.",
    props: ["open", "onOpenChange", "variant"],
    notes: "variant on AlertDialogContent: 'alert' (default/red) | 'success' (green) | 'info' (blue) | 'warning' (orange). Always include AlertDialogIcon as the first child of AlertDialogHeader. Import AlertDialogTrigger, AlertDialogContent, AlertDialogHeader, AlertDialogIcon, AlertDialogTitle, AlertDialogDescription, AlertDialogFooter, AlertDialogAction, AlertDialogCancel from same path.",
  },
  {
    name: "Sheet",
    file: "sheet.tsx",
  ...
  {
    name: "FullPageDialog",
    file: "full-page-dialog.tsx",
    importPath: "@/components/ui/full-page-dialog",
    category: "Organism",
    useFor: "Multi-step wizards and multi-section configuration flows — full-screen overlay with header, sidebar nav, content area, and optional hints panel",
    neverUse: "Never build a custom full-screen div with a manual header + sidebar for multi-step flows",
    variants: ["navStyle: 'section' | 'stepper'"],
    props: ["title", "status", "statusVariant", "actionLabel", "onAction", "onClose", "navStyle", "navItems", "activeNavId", "onNavChange", "showHints", "hintsContent", "children"],
    notes: "Sub-components: FullPageDialogHeader, FullPageDialogNav, FullPageDialogContent, FullPageDialogHints. navStyle='stepper' shows numbered steps.",
  },
  {
    name: "BuilderTopBar",
    file: "builder-top-bar.tsx",
    importPath: "@/components/ui/builder-top-bar",
    category: "Organism",
    useFor: "App builder top bar — dark nav with coloured app icon tile, Design/Workflow/Settings centre tabs, Upgrade pill, Access CTA",
    neverUse: "Never use TopBar for app builder canvas views — use BuilderTopBar instead",
    props: ["appName", "appColor", "activeTab", "onTabChange", "onUpgrade", "onAccess"],
  },
  {
    name: "BuilderLeftNav",
    file: "builder-left-nav.tsx",
    importPath: "@/components/ui/builder-left-nav",
    category: "Organism",
    useFor: "App builder entity tree sidebar — dark collapsible nav with form/report/page/workflow/stage items and user row",
    neverUse: "Never use LeftNav for builder canvas views — use BuilderLeftNav instead",
    props: ["items", "activeId", "onSelect", "collapsed"],
  },
  {
    name: "BuilderShell",
    file: "builder-shell.tsx",
    importPath: "@/components/ui/builder-shell",
    category: "Organism",
    useFor: "Full app builder layout shell — composes BuilderTopBar + BuilderLeftNav + viewport toolbar (Desktop/Tablet/Phone) + canvas + right properties panel slot",
    neverUse: "Never manually compose BuilderTopBar + BuilderLeftNav side by side — use BuilderShell",
    props: ["appName", "appColor", "activeTab", "navItems", "activeNavId", "viewport", "onViewportChange", "propertiesPanel", "children"],
    notes: "Left nav auto-collapses on tablet/phone viewport. Right properties panel is a named slot.",
  },
  {
    name: "List",
    file: "list.tsx",
    ...
    category: "Organism",
    useFor: "Vertical list of structured data rows — optional checkbox, avatar, title + badge, meta text, action CTA, remove button",
    neverUse: "Never use Table, custom <div> rows, or bare <ul> for structured scannable rows without sortable columns",
    props: ["items", "selectable", "onSelect", "onRemove"],
    notes: "Each item: { id, avatar?, title, badge?, meta?, actionLabel?, onAction? }",
  },
  {
    name: "ProductIllustration",
    file: "product-illustration.tsx",
    importPath: "@/components/ui/product-illustration",
    category: "Atom",
    useFor: "Scenario illustrations for empty states and creation wizards — 22 types × Default / Active states",
    neverUse: "Never use hand-drawn <img> or inline SVG per screen for scenario illustrations",
    props: ["type", "state"],
    notes: "state: 'default' | 'active'. 22 illustration types available — see component source for full list.",
  },
  {
    name: "ThemeProvider",
    file: "theme-provider.tsx",
    importPath: "@/components/ui/theme-provider",
    category: "Organism",
    useFor: "Wrap any app subtree to inject brand token overrides via CSS custom properties — all DS components inside automatically pick up the theme",
    neverUse: "Never override --cds-* tokens via a global stylesheet when ThemeProvider can scope them",
    props: ["primaryColor", "primaryColorBold", "primaryColorSubtle", "font", "tokens", "mode", "className"],
    notes: "mode: 'light' | 'dark'. tokens is an escape-hatch Record<string,string> for any --cds-* override.",
  },
  {
    name: "ThemePlayground",
    file: "theme-playground.tsx",
    importPath: "@/components/ui/theme-playground",
    category: "Organism",
    useFor: "Interactive theme customization panel — preset selector (Creator/QEngine/Bookings/Custom), color pickers with auto-derive, radius/density/font/mode controls, live preview, and copy-ready ThemeProvider snippet",
    props: [],
    notes: "Self-contained — no props needed. Shown in the Foundation tab of the DS showcase.",
  },
]
...
export const SCREENS: Screen[] = [
  ...
  // Feature 003 — Demo Users in Environments
  { featureId: "003", featureName: "Demo Users in Environments", screenId: "environments", screenName: "Environments", sourcePath: "src/screens/demo-users/EnvironmentsScreen.tsx" },
  { featureId: "003", featureName: "Demo Users in Environments", screenId: "environment-settings", screenName: "Environment Settings", sourcePath: "src/screens/demo-users/EnvironmentSettingsScreen.tsx" },
  { featureId: "003", featureName: "Demo Users in Environments", screenId: "demo-users-org-pool", screenName: "Demo Users Org Pool", sourcePath: "src/screens/demo-users/DemoUsersOrgPoolScreen.tsx" },
  { featureId: "003", featureName: "Demo Users in Environments", screenId: "demo-users-app-assignment", screenName: "Demo Users App Assignment", sourcePath: "src/screens/demo-users/DemoUsersAppAssignmentScreen.tsx" },
  { featureId: "003", featureName: "Demo Users in Environments", screenId: "demo-users-view-as", screenName: "View As (Persona Switcher)", sourcePath: "src/screens/demo-users/DemoUsersViewAsScreen.tsx" },
  // Feature 004 — Mobile Deployment
  { featureId: "004", featureName: "Mobile Deployment", screenId: "mobile-app-list", screenName: "Mobile App List", sourcePath: "src/screens/mobile-deployment/MobileAppListScreen.tsx" },
  { featureId: "004", featureName: "Mobile Deployment", screenId: "deployment-history", screenName: "Deployment History", sourcePath: "src/screens/mobile-deployment/DeploymentHistoryScreen.tsx" },
  { featureId: "004", featureName: "Mobile Deployment", screenId: "deployment-credentials", screenName: "Deployment Credentials", sourcePath: "src/screens/mobile-deployment/DeploymentCredentialsScreen.tsx" },
  { featureId: "004", featureName: "Mobile Deployment", screenId: "deploy-wizard-channel", screenName: "Deploy Wizard — Channel", sourcePath: "src/screens/mobile-deployment/DeployWizardChannelScreen.tsx" },
  { featureId: "004", featureName: "Mobile Deployment", screenId: "deploy-wizard-play", screenName: "Deploy Wizard — Play Store", sourcePath: "src/screens/mobile-deployment/DeployWizardPlayScreen.tsx" },
  { featureId: "004", featureName: "Mobile Deployment", screenId: "deploy-wizard-firebase", screenName: "Deploy Wizard — Firebase", sourcePath: "src/screens/mobile-deployment/DeployWizardFirebaseScreen.tsx" },
  { featureId: "004", featureName: "Mobile Deployment", screenId: "deploy-in-progress", screenName: "Deploy In Progress", sourcePath: "src/screens/mobile-deployment/DeployInProgressScreen.tsx" },
  { featureId: "004", featureName: "Mobile Deployment", screenId: "play-setup-guide", screenName: "Play Store Setup Guide", sourcePath: "src/screens/mobile-deployment/PlaySetupGuideScreen.tsx" },
]
