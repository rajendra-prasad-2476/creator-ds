...
const actionVariantStyles: Record<PopupAlertVariant, string> = {
  alert: "!bg-[var(--cds-error-surface-bold)] !text-white hover:!bg-[var(--cds-error-surface-bold)]/90 !border-transparent",
  success: "!bg-[var(--cds-success-surface-bold)] !text-white hover:!bg-[var(--cds-success-surface-bold)]/90 !border-transparent",
  info: "!bg-[var(--cds-primary-surface-bold)] !text-white hover:!bg-[var(--cds-primary-surface-bold)]/90 !border-transparent",
  warning: "!bg-[var(--cds-warning-surface-bold)] !text-white hover:!bg-[var(--cds-warning-surface-bold)]/90 !border-transparent",
}
